...
async def get_free_busy(
    ...
    """Fetch busy time blocks via Google Calendar Events list API.

    Uses Events list instead of FreeBusy to avoid propagation delay —
    newly created events are visible immediately.
    """
    ...
    async with httpx.AsyncClient() as client:
        ...
        while True:
            ...
            for event in data.get("items", []):
                ...
                if s and e:
                    busy_slots.append({
                        "start_time": _rfc3339_to_epoch(s),
                        "end_time": _rfc3339_to_epoch(e),
                    })
